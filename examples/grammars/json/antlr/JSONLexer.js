...
class JSONLexer extends Lexer_1.Lexer {
    ...
    static get _ATN() {
        if (!JSONLexer.__ATN) {
            JSONLexer.__ATN = new ATNDeserializer_1.ATNDeserializer().deserialize(
...
JSONLexer.channelNames = ["DEFAULT_TOKEN_CHANNEL", "HIDDEN"]
// tslint:disable:no-trailing-whitespace
...
JSONLexer.VOCABULARY = new VocabularyImpl_1.VocabularyImpl(
    JSONLexer._LITERAL_NAMES,
    JSONLexer._SYMBOLIC_NAMES,
    []
)
JSONLexer._serializedATN =
